        ...
        <Box display="flex" justifyContent='space-between' flexDirection="column" >
          <Stack spacing={2} justifyContent="space-between" flexDirection="column" >
            <Stack flexDirection="row" justifyContent="inherit">
              <Heading as="h3" fontSize={["md", "md", "lg", "xl"]} data-testid={`title-${id}`}>
                {title}
              </Heading>
          ...
          <Flex data-testid="quantity" justifyContent="space-between">
            ...
            <Box display="flex">
              ...
              <Button p="0" disabled={quantity === 0} data-testid={`decrease-quantity-btn-${id}`} onClick={() => onClickHandler(id, -1)} >
